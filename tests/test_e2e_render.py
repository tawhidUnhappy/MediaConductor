...
def fixture_project(tmp_path: Path) -> dict:
    ...
    # Rendering is gated on hash-bound crop/narration approvals with no bypass,
    # so the fixture records reviews over its own generated bytes.
    from mangaeasy.reviews import record_crop_review, record_narration_review
    record_crop_review(proj, ["01"], reviewer="e2e fixture", source_subdir="panels")
    record_narration_review(proj, ["01"], reviewer="e2e fixture")
    return {
        "project_root": proj,
