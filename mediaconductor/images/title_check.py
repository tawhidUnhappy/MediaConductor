"""mediaconductor.images.title_check — check a recap title against the house pattern.

``mediaconductor title-check`` reads a proposed YouTube title and reports the
