#!/usr/bin/env python3
"""mediaconductor.images.convert — convert non-JPG images in download/ to JPG via ffmpeg."""
...
from mediaconductor.paths import download_dir
...
def main() -> None:
    ...
    for file_path in dl_dir.iterdir():
        ...
        result = runtime.run(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        if result.returncode == 0:
            ...
            result2 = runtime.run(cmd_cpu, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
