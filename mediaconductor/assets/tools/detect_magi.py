...
This is exactly the shape MediaConductor reads back in `mediaconductor.panels.ai`. The
module has no mediaconductor imports so it can run inside the isolated tool env.
"""
