"""mediaconductor.tools.smoke — prove a fresh install actually works end to end.

``mediaconductor smoke-test`` builds a tiny throwaway project (two generated
...
def main() -> int:
    ...
    if args.tts == "kokoro":
        result = runtime.run(cli_command(
            "video-audio",
