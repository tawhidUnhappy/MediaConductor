"""mediaconductor.tools.setup — one-command provisioning from a fresh clone.
...
from mediaconductor.tools.hardware import has_nvidia_gpu, nvidia_gpu_name
from mediaconductor.tools.install import TOOLS, InstallError, doctor, install_tool
from mediaconductor.tools.vendored import ensure_core_tools, ensure_vendored_path
