"""mediaconductor.tools.zimage — run Z-Image Turbo image generation in its isolated env.
...
inside the z-image-turbo tool env and emits `MEDIACONDUCTOR_RESULT` with the
