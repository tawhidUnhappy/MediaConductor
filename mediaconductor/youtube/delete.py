"""`mediaconductor youtube-delete` — delete a video from the connected channel.
...
is re-running `mediaconductor youtube-auth`, not code.
...
from mediaconductor.youtube.upload import YouTubeAPIError, _session
