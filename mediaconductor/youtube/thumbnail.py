"""mediaconductor.youtube.thumbnail — set the thumbnail of an already-uploaded video.

``mediaconductor youtube-thumbnail`` replaces a live video's thumbnail through the
...
from mediaconductor.youtube.upload import THUMBNAIL_ENDPOINT, _session, friendly_api_error
