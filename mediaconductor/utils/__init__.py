"""mediaconductor.utils — shared utilities."""
...
def emit_result(**payload) -> None:
    ...
    """
    from mediaconductor.brand import RESULT_MARKERS
...
def parse_result_marker(line: str) -> dict | None:
    ...
    ``MANGAEASY_RESULT`` prefix; every scanner must keep understanding both.
    """
    from mediaconductor.brand import RESULT_MARKERS
