"""mediaconductor.panels.remap — carry narration + audio across a re-crop.
...
``mediaconductor panels-remap`` repairs that without re-narrating or re-running TTS:
...
def parse_args() -> argparse.Namespace:
    from mediaconductor.path_safety import portable_segment_arg, relative_subpath_arg
    from mediaconductor.video_pipeline.common import DEFAULT_AUDIO_ROOT, DEFAULT_PROJECT_ROOT, DEFAULT_WORK_DIR
