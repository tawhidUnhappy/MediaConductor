...
Pipeline per item:
  ...
  5. print a per-item report (panels / suspect pages) + the standard
     MEDIACONDUCTOR_PROGRESS / MEDIACONDUCTOR_RESULT markers
...
from mediaconductor.panels.ai import _clamp_box, _manga_reading_order
from mediaconductor.panels.gutter import collect_image_paths
from mediaconductor.panels.webtoon import _archive_existing_panels, write_contact_sheets
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.reading_direction == "auto":
        from mediaconductor.panels.direction import project_reading_direction
