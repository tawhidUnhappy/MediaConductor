"""mediaconductor.panels.overrides_tool — build webtoon-split overrides from the CLI.

``mediaconductor webtoon-override`` maintains the per-item overrides JSON that
