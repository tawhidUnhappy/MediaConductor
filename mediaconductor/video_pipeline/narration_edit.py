"""mediaconductor.video_pipeline.narration_edit — edit narration entries from the CLI.

``mediaconductor narration-edit`` upserts, deletes and lists entries in an item's
...
def parse_args() -> argparse.Namespace:
    from mediaconductor.video_pipeline.common import DEFAULT_AUDIO_ROOT, DEFAULT_PROJECT_ROOT
