"""`mediaconductor library-list` — discover projects and per-item readiness.
...
def scan_project(project_dir: Path) -> dict:
    ...
    # manga.json is written by `mediaconductor download` (source site, title URL,
    # manga_id, downloaded chapters) — see mediaconductor/download/mangadex.py.
