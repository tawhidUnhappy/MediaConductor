"""mediaconductor.series_plan — plan and track fixed-size upload batches.
...
- ``mediaconductor series-plan`` answers "which batch is next?": it slices the
...
def item_readiness(item_dir: Path) -> dict:
    ...
    from mediaconductor.video_pipeline.common import IMAGE_EXTENSIONS
