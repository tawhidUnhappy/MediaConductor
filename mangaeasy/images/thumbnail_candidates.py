"""mangaeasy.images.thumbnail_candidates — shortlist panels worth compositing.

``mangaeasy thumbnail-candidates`` answers one question: *of the few
...
def build_sheets(candidates: list[dict], out_dir: Path, project: str) -> list[Path]:
    ...
    from mangaeasy.images.thumbnail_compose import load_font
