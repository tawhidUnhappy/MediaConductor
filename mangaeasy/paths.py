"""mangaeasy.paths
Per-chapter folder conventions, built on top of :mod:`mangaeasy.layout`.
...
from mangaeasy.layout import library_root
...
def library_dir() -> Path:
    ...
    ``data/library/`` (see :func:`mangaeasy.layout.library_root`), named
